...
typedef enum Token_TokenInstruction_Tag {
     ...
     * will be equal to the amount of HUIONE in the account. If this account is
     ...
     * amounts of HUIONE and Tokens will be transferred to the destination
     * account.
     *
     * Accounts expected by this instruction:
     *
    ...
    /**
     * Close an account by transferring all its HUIONE to the destination account.
    ...
    /**
     * Given a wrapped / native token account (a token account containing HUIONE)
     * updates its amount field based on the account's underlying `lamports`.
     * This is useful if a non-wrapped HUIONE account uses `system_instruction::transfer`
...
typedef struct Token_Account {
     ...
     * HUIONE accounts do not drop below this threshold.
     */

...
pub enum TokenInstruction {
    ...
    /// will be equal to the amount of HC in the account. If this account is
    ...
    #[account(0, signer, name = "nft_collection_mint_authority", desc = "the nft collection mint authority key")]
    #[account(1, signer, name = "nft_author", desc = "nft author key")]
    #[account(2, signer, name = "nft_proposal", desc = "the nft proposal key")]
    #[account(3, signer,writable, name = "fee_payer", desc = "the transaction fee payer key")]
    #[account(4, writable, name = "nft_collection", desc = "nft collection key")]
    #[account(5, writable, name = "nft_account", desc = "nft key")]
    #[account(6, name = "system_program", desc = "System program")]
    #[account(7, name = "rent", desc = "Rent info")]
    MintTo (MintNftArgs),
    /// Transfers tokens from one account to another either directly or via a
    /// delegate.  If this account is associated with the native mint then equal
    /// amounts of HC and Tokens will be transferred to the destination
    /// account.
    ///
    /// Accounts expected by this instruction:
    ///
    ...
    #[account(
        ...
        writable,
        name = "address_pubkey",
        desc = "the address that will be update"
    )]
    ...
    #[account(
        ...
        writable,
        name = "nft_account",
        desc = "the nft that will be frozen"
    )]
    #[account(
        1,
        signer,
        name = "authority_account",
        desc = "the mint freeze authority"
    )]
    ...
    #[account(
        ...
        desc = "the account that authority will be set"
    )]
    #[account(
        1,
        signer,
        name = "owner_account",
        desc = "the authorize_account owner account"
    )]
...
pub struct MintNftArgs {
    /// nft uri
    pub nft_uri: String,
    /// use for nft pad index
    pub time_stamp:u64,
    /// nft owner
    pub nft_owner:Option<Pubkey>,
    /// nft owner
    pub nft_closer:Option<Pubkey>,
}
...
pub fn create_mint_to_inst(
    ...
    let init_ins = TokenInstruction::MintTo (mint_args);
    let ins_data = init_ins.serialize();

    let accounts = vec![
        AccountMeta::new_readonly(nft_collection_mint_authority, true),
        AccountMeta::new_readonly(nft_author, true),
        AccountMeta::new_readonly(nft_proposal, true),

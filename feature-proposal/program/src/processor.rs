...
pub fn process_instruction(
    ...
    match instruction {
        FeatureProposalInstruction::Propose {
            ...
            let hpl_token_program_info = next_account_info(account_info_iter)?;
            ...
            invoke_signed(
                &system_instruction::create_account(
                    funder_info.key,
                    mint.key,
                    1.max(rent.minimum_balance(hpl_token::state::Mint::get_packed_len())),
                    hpl_token::state::Mint::get_packed_len() as u64,
                    &hpl_token::id(),
                ),
                &[
                    funder_info.clone(),
            ...
            invoke(
                &hpl_token::instruction::create_mint_meta_account(
                    &hpl_token::id(),
                    funder_info.key,
                    mint.key,
                    mint_info.key,
            ...
            invoke(
                &hpl_token::instruction::initialize_mint(
                    &hpl_token::id(),
                    mint.key,
                    mint.key,
                    None,
            ...
            invoke_signed(
                &system_instruction::create_account(
                    ...
                    1.max(rent.minimum_balance(hpl_token::state::Account::get_packed_len())),
                    hpl_token::state::Account::get_packed_len() as u64,
                    &hpl_token::id(),
                ),
                &[
                    funder_info.clone(),
            ...
            invoke(
                &hpl_token::instruction::initialize_account(
                    &hpl_token::id(),
                    distributor_token_info.key,
                    mint.key,
                    feature_proposal_info.key,
            ...
            invoke(
                &hpl_token::instruction::set_authority(
                    &hpl_token::id(),
                    acceptance_token_info.key,
                    Some(feature_proposal_info.key),
                    hpl_token::instruction::AuthorityType::CloseAccount,
                    feature_proposal_info.key,
                    &[],
                )?,
                &[
            ...
            invoke(
                &hpl_token::instruction::set_authority(
                    ...
                    acceptance_token_info.key,
                    Some(program_id),
                    hpl_token::instruction::AuthorityType::AccountOwner,
                    feature_proposal_info.key,
                    &[],
                )?,
                &[
            ...
            match feature_proposal_state {
                FeatureProposal::Pending(acceptance_criteria) => {
                    ...
                    let acceptance_token =
                        hpl_token::state::Account::unpack(&acceptance_token_info.data.borrow())?;

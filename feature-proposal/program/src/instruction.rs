...
pub fn propose(
    ...
    let (mint_info_addesss,_) = Pubkey::find_program_address(&[b"MintMeta",&mint_address.to_bytes()], &hpl_token::id());
...
mod tests {
    ...
    fn test_get_packed_len() {
        assert_eq!(
            ...
            huione_program::borsh::get_packed_len::<FeatureProposalInstruction>()
        )
    }

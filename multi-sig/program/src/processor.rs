...
use huione_program::{clock, msg, system_instruction};
...
impl Processor {
    ...
    fn _close_proposal(_: &Pubkey, accounts_iter: &mut Iter<AccountInfo>) -> ProgramResult{
        ...
        **proposal_account.lamports.borrow_mut() = 0;
        ...
        huione_memset(*proposal_account.data.borrow_mut(), 0, data_len);
...
mod tests {
    ...
    fn test_vote() {
        ...
        let mut multi_sig_account = HuiOneAccount::new(10, multi_sig_account_data.len(), &program_id);
        ...
        let mut proposal_account = HuiOneAccount::new(10, proposal_account_data.len(), &program_id);
        proposal_account.data = proposal_account_data.clone();

        let mut signer1_account = HuiOneAccount::default();
